...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed w-full z-50   md:bg-gradient-to-b from-black/50 to-transparent border-b md:border-none ${isOpen ? "bg-white" : "bg-transparent"}`}>
      <div className="max-w-7xl mx-auto px-4 py-4">
        {/* Desktop and Mobile Header */}
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center">
              <h1 className={`text-3xl font-bold ${isOpen ? "text-emerald-600" : "text-[#E6F5F0]"}`}>
                Changa
              </h1>
            </Link>
            <Link
          ...
          <div className="md:hidden flex gap-2">
            ...
            <button
              ...
              className={`p-2 hover:bg-white/10 rounded-lg transition-colors ${isOpen ? "text-emerald-600" : "text-[#E6F5F0]"}`}
            >
